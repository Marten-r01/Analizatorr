...
import { importObject, setWasmExports } from './frontend.import-object.mjs'
...
const wasmFilePath = './frontend.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./frontend.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
